...
export default function Home() {
    ...
    const loadDashboardData = async () => {
        try {
            ...
            const [accountsRes, transactionsRes, categoriesRes] =
                await Promise.all([
            ...
            try {
                const monthlyTransactionsRes = await axios.get(
                    "/api/transactions",
                    {
                        params: {
                            date_from: `${currentYear}-${String(
                                currentMonth + 1
                            ).padStart(2, "0")}-01`,
                            date_to: `${currentYear}-${String(
                                currentMonth + 1
                            ).padStart(2, "0")}-31`,
                ...
                const monthlyTransactions =
                    monthlyTransactionsRes.data.data ||
                    monthlyTransactionsRes.data;
                ...
                console.error(
                    "Error loading monthly transactions:",
                    monthlyError
                );
            }
    ...
    if (!isLoggedIn()) {
        return (
            <div style={{ padding: "20px", textAlign: "center" }}>
                ...
                >
                    Take control of your finances. Track expenses, manage
    ...
    return (
        <div style={{ padding: "20px" }}>
            ...
            >
                <h1 style={{ fontSize: "28px", color: "#2d3e50" }}>
                    Financial Dashboard
                </h1>
                <CustomButton
                    label="Logout"
            ...
            >
                ...
                >
                    ...
                    <p style={{ color: "#666", fontSize: "14px" }}>
                        Across {dashboardData.totalAccounts} account
                        {dashboardData.totalAccounts !== 1 ? "s" : ""}
                    </p>
                </div>
